...
Before creating a new Issue, please check first if a similar Issue [already exists](https://github.com/adminbaintex/gomqtt/server/issues?state=open) or was [recently closed](https://github.com/adminbaintex/gomqtt/server/issues?direction=desc&page=1&sort=updated&state=closed).
